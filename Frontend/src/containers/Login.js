...
export default class Login {
  ...
  handleSubmitAdmin = e => {
    ...
    const user = {
      ...
      // email: e.target.querySelector(`input[data-testid="employee-email-input"]`).value, // employé to admin
      // password: e.target.querySelector(`input[data-testid="employee-password-input"]`).value,
      status: "connected"
    }
    ...
    this.login(user)
      .catch(
        this.onNavigate(ROUTES_PATH['Login']) // ajout de la bonne route en cas d'erreur dans l'entré des champs
      )
      .then(() => {
